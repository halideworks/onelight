...
- One exception to that neutrality, decided by David on 2026-07-21: the AUDIO stage (waveform and spectrograph) carries colour in the review room too. Neutrality protects colour judgement of a picture, and an audio asset has no picture; a frequency reading in grey is a texture rather than an instrument. The waveform is the palette's straw and the spectrogram ramps through it. This does not license colour anywhere near footage.
